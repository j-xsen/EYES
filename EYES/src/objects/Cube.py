...
import random
from EYES.config.Config import rotate_time
from EYES.src.utility.Functions import get_random_hpr, get_random_position
from EYES.src.utility.Color import Color
from EYES.src.objects.Object import Object, ObjectType
