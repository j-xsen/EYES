...
from EYES.src.objects.WorldObjectHolder import WorldObjectHolder
from EYES.src.objects.Object import ObjectType
from EYES.src.utility.Functions import get_random_position
from EYES.src.objects.Cube import Cube
from EYES.src.objects.Eye import Eye
from EYES.src.utility.Map import Map
from EYES.config.Config import color_groups, min_cubes, max_cubes, min_eyes, max_eyes, number_eye_variants
