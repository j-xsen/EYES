...
from EYES.src.utility.Color import ColorGroup
from EYES.src.utility.Map import Map, MapNode
...
rotate_time = ConfigVariableInt('rotate-time', 3).getValue()
gifs_to_make = ConfigVariableInt('gifs-to-make', 50).getValue()
min_cubes = ConfigVariableInt('min-cubes', 300).getValue()
max_cubes = ConfigVariableInt('max-cubes', 400).getValue()
min_eyes = ConfigVariableInt('min-eyes', 256).getValue()
max_eyes = ConfigVariableInt('max-eyes', 1024).getValue()
fps = ConfigVariableInt('fps', 10).getValue()
